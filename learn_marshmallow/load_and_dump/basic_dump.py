...
def test_basic():
    ...
    print(result.data) # {'name': 'David', 'email': 'david@email.com'}
...
def test_error():
    ...
    result = user_schema.dump(user)
    print(result.data) # {'name': 'David'} 错误项不会被序列化
    print(result.errors) # {'email': ['Not a valid email address.']}
